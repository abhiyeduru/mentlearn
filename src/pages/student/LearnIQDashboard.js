...
export default function LearnIQDashboard() {
  ...
  const [showMindneoX, setShowMindneoX] = useState(false);
    ...
    <div className="min-h-screen bg-[#F6F8FC] font-['Inter']">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8 flex items-center justify-between">
          ...
          <button
            ...
            title="Open MindneoX AI"
          >
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
            </svg>
            <span className="font-semibold hidden sm:inline">MindneoX AI</span>
          </button>
        </div>
      ...
      {showMindneoX && (
        <div 
          ...
          onClick={() => setShowMindneoX(false)}
        >
          <div 
            className="fixed right-0 top-0 bottom-0 w-full sm:w-[450px] md:w-[500px] lg:w-[550px] bg-white shadow-2xl flex flex-col"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Modal Header */}
            <div className="flex items-center justify-between p-4 border-b border-gray-200 bg-gradient-to-r from-purple-600 to-blue-600 flex-shrink-0">
              <div className="flex items-center gap-2 text-white">
                {/* Back button for mobile */}
                <button
                  onClick={() => setShowMindneoX(false)}
                  className="sm:hidden p-2 hover:bg-white/20 rounded-lg transition-colors mr-2"
                  aria-label="Back"
                >
