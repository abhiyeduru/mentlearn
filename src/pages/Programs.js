...
const programs = [
  {
    title: "Academy Track",
    description: "Semester-style path for 1st–3rd year students with mentor labs and projects.",
    link: "/programs/academy-track",
    icon: <FaRocket className="text-3xl text-[#007bff]" />
  },
  {
    title: "Intensive Track",
    description: "Placement-focused bootcamp for graduates with mocks, projects, and referrals.",
    link: "/programs/intensive-track",
    icon: <FaUserGraduate className="text-3xl text-purple-500" />
  },
  {
    title: "Launchpad",
    description: "Fast-track bootcamp for career switchers with 1:1 mentorship and hiring day.",
