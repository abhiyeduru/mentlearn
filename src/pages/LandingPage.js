  ...
  return (
    <>
      <div className="bg-white text-gray-800 min-h-screen">
                    ...
                    <div className="flex items-center gap-4 overflow-x-auto scrollbar-hide max-w-3xl px-4">
                      {testimonials.map((testimonial, index) => (
                        <button
                          ...
                          className={`flex-shrink-0 transition-all duration-300 ${currentTestimonial === index
                  ...
                  <div className="flex justify-center gap-2 mt-6">
                    {promoBanner.map((_, index) => (
                      <button
                        ...
                        className={`h-2 rounded-full transition-all duration-300 ${currentBannerIndex === index
                            ? 'w-8 bg-blue-600'
        ...
        {/* Advisor Modal Popup */}
        {showAdvisorModal && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 p-2 sm:p-4 animate-fadeIn overflow-y-auto">
            <div className="relative bg-white rounded-xl sm:rounded-2xl shadow-2xl max-w-4xl w-full my-4 sm:my-8 overflow-hidden animate-slideUp max-h-[95vh] sm:max-h-[90vh] flex flex-col">
              {/* Close Button */}
              <button
                onClick={() => setShowAdvisorModal(false)}
                className="absolute top-2 right-2 sm:top-4 sm:right-4 z-10 bg-white rounded-full p-1.5 sm:p-2 hover:bg-gray-100 transition-colors shadow-lg"
                aria-label="Close"
              >
              ...
              <div className="flex flex-col md:flex-row overflow-y-auto">
                ...
                <div className="bg-blue-700 text-white p-4 sm:p-6 md:p-8 md:w-1/2 flex flex-col justify-between relative overflow-hidden">
                  {/* Decorative Elements */}
                  <div className="absolute top-0 right-0 w-32 h-32 sm:w-48 sm:h-48 md:w-64 md:h-64 bg-yellow-400 rounded-full -translate-y-1/2 translate-x-1/2 opacity-20"></div>
                  <div className="absolute bottom-0 left-0 w-24 h-24 sm:w-36 sm:h-36 md:w-48 md:h-48 bg-yellow-400 rounded-full translate-y-1/2 -translate-x-1/2 opacity-20"></div>
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="space-y-2 sm:space-y-3 md:space-y-4 mb-4 sm:mb-6 md:mb-8">
                      <p className="text-sm sm:text-base md:text-lg font-semibold text-yellow-300">AND GET</p>
                      <div className="space-y-2 sm:space-y-3">
                        <div className="flex items-start gap-2 sm:gap-3">
                          <span className="text-yellow-400 text-base sm:text-lg md:text-xl">✨</span>
                          <span className="text-xs sm:text-sm md:text-base lg:text-lg">Personalized Career Roadmap</span>
                        </div>
                        <div className="flex items-start gap-2 sm:gap-3">
                          <span className="text-yellow-400 text-base sm:text-lg md:text-xl">✨</span>
                          <span className="text-xs sm:text-sm md:text-base lg:text-lg">Free Career Counselling</span>
                        </div>
                        <div className="flex items-start gap-2 sm:gap-3">
                          <span className="text-yellow-400 text-base sm:text-lg md:text-xl">✨</span>
                          <span className="text-xs sm:text-sm md:text-base lg:text-lg">Free Access to Mentneo Events</span>
                        </div>
                      </div>
                    </div>
                  </div>

                  {/* Advisor Image - Hidden on small mobile, shown on larger screens */}
                  <div className="relative z-10 hidden sm:flex justify-center md:justify-start mt-4">
                    <div className="relative">
                      ...
                      <img
                        ...
                        alt="Career Advisor"
                        className="relative w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 lg:w-56 lg:h-56 object-cover rounded-lg shadow-2xl"
                      />
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4 sm:p-6 md:p-8 md:w-1/2 bg-white">
                  <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-gray-900 mb-4 sm:mb-6">
                    Talk to our Advisor!
                  </h3>

                  <form onSubmit={handleAdvisorFormSubmit} className="space-y-3 sm:space-y-4">
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-gray-50"
                      >
                        <option value="">Select Program</option>
                        <option value="Full Stack Development">Full Stack Development</option>
                        <option value="Data Science">Data Science</option>
                    ...
                    <div>
                      ...
                      <div className="flex gap-2">
                        <select className="px-2 sm:px-3 py-2 sm:py-3 text-sm sm:text-base border border-gray-300 rounded-lg bg-gray-50 w-16 sm:w-20 md:w-24">
                          <option value="+91">+91</option>
                        </select>
                        <input
                          type="tel"
                          ...
                          placeholder="Enter Phone"
                          className="flex-1 px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-gray-50"
                        />
                      </div>
                    </div>
                    ...
                    <button
                      ...
                      className="w-full bg-pink-600 hover:bg-pink-700 text-white font-bold py-3 sm:py-4 px-4 sm:px-6 text-sm sm:text-base rounded-lg transition-all shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed mt-2 sm:mt-4"
                    >
