      ...
      <div className="py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8">
            ...
            <h2 className="text-lg font-medium text-gray-900 mt-8">Landing Page Content</h2>
            <div className="mt-4 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
              <Link to="/admin/showcase-videos" className="bg-gradient-to-r from-purple-500 to-indigo-600 overflow-hidden shadow-lg rounded-lg hover:shadow-xl transition-all transform hover:scale-105">
                <div className="px-4 py-5 sm:p-6 text-center">
                  <svg className="mx-auto h-8 w-8 text-white mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
                  </svg>
                  <h3 className="text-lg font-medium text-white">Showcase Videos</h3>
                  <p className="text-xs text-purple-100 mt-1">Manage landing videos</p>
                </div>
              </Link>
              
              <Link to="/admin/promo-banners" className="bg-white overflow-hidden shadow rounded-lg hover:shadow-md transition-shadow">
                <div className="px-4 py-5 sm:p-6 text-center">
                  <h3 className="text-lg font-medium text-gray-900">Promo Banners</h3>
                </div>
              </Link>
              
              <Link to="/admin/testimonials" className="bg-white overflow-hidden shadow rounded-lg hover:shadow-md transition-shadow">
                <div className="px-4 py-5 sm:p-6 text-center">
                  <h3 className="text-lg font-medium text-gray-900">Testimonials</h3>
                </div>
              </Link>
              
              <Link to="/admin/hiring-partners" className="bg-white overflow-hidden shadow rounded-lg hover:shadow-md transition-shadow">
                <div className="px-4 py-5 sm:p-6 text-center">
                  <h3 className="text-lg font-medium text-gray-900">Hiring Partners</h3>
                </div>
              </Link>
            </div>
          </div>
