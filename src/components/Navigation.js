              ...
              >
                ...
                <dl className="mt-8 space-y-6">
                  ...
                  <dd className="flex text-base text-indigo-50">
                    ...
                    <span className="ml-3">+91 9182146476</span>
                  </dd>
                  <dt><span className="sr-only">Email</span></dt>
                  <dd className="flex text-base text-indigo-50">
                    <FaEnvelope className="flex-shrink-0 w-6 h-6 text-indigo-200" aria-hidden="true" />
                    <span className="ml-3">official@mentlearn.in</span>
                  </dd>
                  <dt><span className="sr-only">Address</span></dt>
                  <dd className="flex text-base text-indigo-50">
                    <FaMapMarkerAlt className="flex-shrink-0 w-6 h-6 text-indigo-200" aria-hidden="true" />
                    <span className="ml-3">Kakinada, 533001</span>
                  </dd>
                </dl>
                <ul className="mt-12 flex space-x-6">
                  <li>
                    <a className="text-indigo-200 hover:text-indigo-100" href="https://facebook.com/mentneo" target="_blank" rel="noopener noreferrer">
                      <span className="sr-only">Facebook</span>
                      <FaFacebookF className="h-6 w-6" aria-hidden="true" />
                    </a>
                  </li>
                  <li>
                    <a className="text-indigo-200 hover:text-indigo-100" href="https://twitter.com/mentneo" target="_blank" rel="noopener noreferrer">
                      <span className="sr-only">Twitter</span>
                      <FaTwitter className="h-6 w-6" aria-hidden="true" />
                    </a>
                  </li>
                  <li>
                    <a className="text-indigo-200 hover:text-indigo-100" href="https://instagram.com/mentneo" target="_blank" rel="noopener noreferrer">
                      <span className="sr-only">Instagram</span>
                      <FaInstagram className="h-6 w-6" aria-hidden="true" />
                    </a>
                  </li>
                  <li>
                    <a className="text-indigo-200 hover:text-indigo-100" href="https://linkedin.com/company/mentneo" target="_blank" rel="noopener noreferrer">
      ...
      <div className="bg-white dark:bg-slate-800 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="relative h-96 w-full">
              <LoadScript googleMapsApiKey={process.env.REACT_APP_GOOGLE_MAPS_API_KEY}>
                ...
                >
                  <Marker position={center} title="Mentneo Office" />
                </GoogleMap>
              </LoadScript>
            </div>
          </motion.div>
          <div className="mt-8 text-center text-gray-500 dark:text-gray-400">
            <p>Kakinada, 533001</p>
            <p className="mt-2">Open Monday - Friday, 9AM - 6PM IST</p>
          </div>
        </div>
      </div>
          ...
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            <div className="space-y-8 xl:col-span-1">
              ...
              <div className="flex space-x-6">
                <a href="https://facebook.com/mentneo" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-500 dark:hover:text-gray-300">
                  <span className="sr-only">Facebook</span>
                ...
                <a href="https://instagram.com/mentneo" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-500 dark:hover:text-gray-300">
                  <span className="sr-only">Instagram</span>
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <a href="https://twitter.com/mentneo" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-500 dark:hover:text-gray-300">
                  <span className="sr-only">Twitter</span>
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <a href="https://linkedin.com/company/mentneo" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-500 dark:hover:text-gray-300">
                  <span className="sr-only">LinkedIn</span>
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
